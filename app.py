...
def get_db_connection():
    ...
    try:
        # Verifica se as secrets estão configuradas no novo formato
        ...
        connection = psycopg2.connect(
            ...
            user=db["username"], # Mudou de 'user' para 'username' para bater com o TOML
            password=db["password"],
            port=db.get("port", "5432") # Adicionada a porta
        )
        return connection
...
dialect = "postgresql"
host = "db.jcvczxifkgldjledqjyk.supabase.co"
port = "5432"
database = "postgres"
username = "postgres"
